...
const Menu = () => {
    ...
    const length = allCocktails.length;
    const goToSlide = (index) => {
        const newIndex = (index + length)%length;
        setCurrentIndex(newIndex);
    } 

    const getCocktailAt = (indexOffset) => {
        return allCocktails[(currentIndex + indexOffset + length) % length];
    }
  ...
  return (
    <section id="menu" aria-labelledby="menu-heading">
        ...
        <div className="content">
            ...
            <button className="text-left flex flex-col items-end" onClick={() => goToSlide(currentIndex + 1)}>
                <p>{nextCocktail.name}</p>
